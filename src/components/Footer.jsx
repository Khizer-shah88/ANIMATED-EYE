...
const Footer = () => {
  return (
    <div className='w-full flex flex-col sm:flex-row gap-5 h-auto sm:h-screen bg-zinc-100 p-5 sm:p-20'>
        <div className='w-full sm:w-1/2 h-full flex flex-col justify-between'>
            <div className='heading'>
                <h1 className='text-[10vw] sm:text-[6vw] font-bold uppercase leading-none -mb-10'>-Eye-</h1>
                <h1 className='text-[10vw] sm:text-[6vw] font-bold uppercase m-8 leading-none'>Opening</h1>
            </div>
       ...
       <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-full sm:w-1/2'>
            <h1 className='text-[10vw] sm:text-[6vw] font-bold uppercase leading-none -mb-7'>presentations</h1>
            <div className='det mt-8 sm:mt-24'>  
                {["Instagram", "Facebook", "Twitter", "Wattsapp", "Linkedin", "Pinterest", "Youtube"].map((item, index) => (
