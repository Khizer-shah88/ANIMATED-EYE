...
export default function CustomNavbar() {
  ...
  return (
    <Navbar className="bg-transparent text-white sm:hover:text-yellow-400 fixed" onMenuOpenChange={setIsMenuOpen}>
      <NavbarContent>
        <NavbarMenuToggle
      ...
      <NavbarContent className="hidden sm:flex gap-4 " justify="center">
        ...
        <NavbarItem>
          <Link  className="text-white m-4 " color="foreground" href="/contact">
           Contact us
          </Link>
        </NavbarItem>
        <NavbarItem>
          <Link  className="text-white m-4 " color="foreground" href="/login">
           Login
          </Link>
        </NavbarItem>
      </NavbarContent>
